...
import AdminImageCommentUserModal from "./AdminImageCommentUserModal";


const AdminImageCommentUser = ({id, setStatusResponse}) => {
    ...
    return (
        <div className={'div_image_comment_apartment_main'}>
            {
                photo && photo.map((c, index) => <AdminImageCommentUserModal key={index}
                                                                                  image={c.url}
                                                                                  id={c.id}
                ...
                </AdminImageCommentUserModal>)
            }
        </div>
    );
};

export default AdminImageCommentUser;